...
private:
    ...
    std::unique_ptr<ComboAttachment> subWaveAttach;

    // === FILTER PANEL ===
    juce::GroupComponent filterPanel;
    SkuntComboBox filterTypeBox;
    SkuntKnob filterCutoffKnob, filterResKnob, filterDriveKnob, filterMixKnob, filterKeyTrackKnob;
    std::unique_ptr<ComboAttachment> filterTypeAttach;
    std::unique_ptr<Attachment> filterCutoffAttach, filterResAttach;
    std::unique_ptr<Attachment> filterDriveAttach, filterMixAttach, filterKeyTrackAttach;
